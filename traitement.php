...
<div id="container">
    ...
    <div id="jeu">   
        ...
        $perso1= new personnage($_GET['nomPerso1'], $_GET['forceBrut1'], $_GET['forceMagique1'], $_GET['armure1'], $_GET['soin1'], $_GET['vie1'] );
        $perso2= new personnage($_GET['nomPerso2'], $_GET['forceBrut2'], $_GET['forceMagique2'], $_GET['armure2'], $_GET['soin2'], $_GET['vie2'] );
